...
const alive = async (m, Matrix) => {
  ...
  if (cmd === ".alive") {
    ...
    const audtxt = `Hey ${m.pushName} ${pushwish}. में पिछले ${hours} घंटा ${minutes} minutes और ${seconds} seconds से जिंदा हूं. और कब तक जिन्दा रहूंगा इसका कोई गारेंटी नहीं हे.`
